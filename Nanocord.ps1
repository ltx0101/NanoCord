...
$iconUrl = "${githubRepoUrl}logo.ico"
Write-Host "Downloading logo.ico from GitHub..."
Invoke-WebRequest -Uri $iconUrl -OutFile $iconDestination

if (Test-Path $iconDestination) {
    Write-Host "Icon downloaded and saved to $iconDestination."
} else {
    Write-Host "Failed to download the icon. Using default icon."
